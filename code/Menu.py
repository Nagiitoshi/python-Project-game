...
class Menu:
    def __init__(self, window):
        ...
        self.surf = pygame.image.load('/home/endil/PycharmProjects/python-Project-facul/dowload/re:zeroRem.jpeg')
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(50, "Royal Room", COLOR_ORANGE, ((WIN_WIDTH / 2), 70))
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    pygame.quit()
                    sys.exit()
                if event.type == pygame.KEYDOWN:  # testar se algume tecla foi pressionada
