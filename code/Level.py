...
class Level:
    def __init__(self, window, name, menu_option):
        ...
        self.name = name
        self.mode = menu_option  # option do menu
    ...
    def run(self):
        pygame.mixer_music.load('/home/endil/PycharmProjects/python-Project-facul/dowload/music2.mp3')
        ...
        while True:
            ...
            # Atualizar a tela
            pygame.display.flip()
            # Verrificar relacionamentos de entidades
